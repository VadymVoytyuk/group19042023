...
item_1_zina_format = format(item_1_zina, '.2f')
...
item_2_zina_format = format(item_2_zina, '.2f')

total_quantity = Decimal(item_1_quantity) + Decimal(item_2_quantity)
...
print(printing_template.format(item_1_title, item_1_quantity, item_1_zina_format, item_1_total_cost_right_format))
print(printing_template.format(item_2_title, item_2_quantity, item_2_zina_format, item_2_total_cost_right_format))
print('~' * 80)
print(printing_template.format('ВСЬОГО'.ljust(20), total_quantity, 'x',
